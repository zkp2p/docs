...
| A custom taker flow, backend, or internal tool | [Client Reference](/developer/sdk/sdk-client-reference) | Covers `Zkp2pClient`, intents, quotes, vaults, helpers, and API-backed flows |
| A React app | [React Hooks](/developer/sdk/sdk-react-hooks) | Covers the `@zkp2p/sdk/react` hook layer for transaction UX |
...
| --- | --- | --- |
| `Zkp2pClient` | The canonical SDK client for reads, writes, and API-backed flows | [Client Reference](/developer/sdk/sdk-client-reference) |
...
| `client.indexer` | Advanced deposit, intent, and fulfillment queries | [Client Reference](/developer/sdk/sdk-client-reference#indexer) |
| Contract helpers | `getContracts`, `getRateManagerContracts`, `getPaymentMethodsCatalog`, `getGatingServiceAddress` | [Client Reference](/developer/sdk/sdk-client-reference#contract-helpers) |
| Currency and payment helpers | `currencyInfo`, `resolveFiatCurrencyBytes32`, payment-method hash helpers | [Client Reference](/developer/sdk/sdk-client-reference#contract-helpers) |
| Attribution and fee helpers | ERC-8021 helpers and referrer fee validation utilities | [Client Reference](/developer/sdk/sdk-client-reference#referrer-fees) |
| React hooks | Transaction-oriented hooks for deposits, intents, and vaults | [React Hooks](/developer/sdk/sdk-react-hooks) |
...
2. Use [Client Reference](/developer/sdk/sdk-client-reference) to look up concrete methods, request shapes, and helper exports.
3. Use [React Hooks](/developer/sdk/sdk-react-hooks) if you want component-level loading, error, and transaction state.
