...
6. **Set a Floor Rate (Optional)**
   ...
   At the bottom of the rate panel, toggle **Floor** on to set a minimum rate. See [How to Set a Floor Rate](arm-floor-rates) for details.
...
➡️ _Next: [How to Set a Floor Rate](arm-floor-rates)_
