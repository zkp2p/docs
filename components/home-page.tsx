...
function HomepageHero() {
  return (
    <div className={styles.heroContainer}>
      <h1 className={styles.heroTitle}>Welcome to Peer Docs</h1>
...
function CommunitySection() {
  const communityLinks = [
    ...
    },
    {
      ...
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="90 90 330 330" fill="currentColor" aria-hidden="true" focusable="false">
      ...
      <div className={styles.container}>
        ...
        <div className={styles.communityGrid}>
          {communityLinks.map((link) => (
            <a key={link.label} href={link.href} className={styles.communityCard} target="_blank" rel="noreferrer">
              <div className={styles.communityIconWrapper}>{link.icon}</div>
