...
export default function ZKP2PAndBanking() {
  const {siteConfig} = useDocusaurusContext();
  
  const post = {
    title: 'ZKP2P and Banking',
    date: '2024-06-05',
    excerpt: 'In a world where crypto users get de-banked, we\'ve heard a lot of questions like "Will Wise close my account if I use ZKP2P?" The short answer is they shouldn\'t, but the long answer is slightly more complex.',
    content: `
