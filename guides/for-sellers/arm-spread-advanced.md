...
title: Set Your Spread - Advanced Flow
---

# Set Your Spread: Advanced Flow

The advanced flow gives you the full orderbook, a spread slider, floor rate controls, and support for multiple currencies on a single deposit.
...
### Step 4: Add Your Currencies

On the right side, you'll see currency tabs. Click **+ Add** to accept additional currencies on this deposit. Each currency gets its own spread and rate.

### Step 5: Set Your Spread

For each currency, use the **spread slider** (ranges from -5% to +5%) or the **+/- buttons** to set your rate.
...
![Advanced flow - setting spread](/img/arm/arm-advanced-default.png)

### Step 6: Set a Floor Rate (Optional)
...
![Advanced flow - spread and floor configured](/img/arm/arm-advanced-spread-floor.png)

### Step 8: Review Deposit

Click **Review Deposit** to confirm everything looks right, then approve the transaction in your wallet.

## Updating Your Spread Later

To change your spread after creating a deposit:
...
4. Adjust your spread using the slider or +/- buttons
5. Confirm the update

Your new spread takes effect immediately for all future orders.
